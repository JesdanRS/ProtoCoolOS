document.addEventListener('DOMContentLoaded', function() {
    const pasos = [
        ...
        },
        {
            ...
            mensaje: 'Gurada una lista ya elaborada en un archivo json.',
        },
        {
            elemento: document.getElementById('cargarBtn'),
            mensaje: 'Importa un trabajo previamente realizado.',
        },
        {
            elemento: document.getElementById('selectionBtn'),
            mensaje: 'Aplica el orden de Selection Sort.',
        },
        {
            elemento: document.getElementById('insertionBtn'),
            mensaje: 'Aplica el orden de Insertion Sort.',
        },
        {
            elemento: document.getElementById('shellBtn'),
            mensaje: 'Aplica el orden de Shell Sort.',
        },{
            elemento: document.getElementById('mergeBtn'),
            mensaje: 'Aplica el orden de Merge Sort.',
        },
        {
            elemento: document.getElementById('resultado-container'),
            mensaje: 'En este contenedor apareceran detalles del resultado optenido despues de aplicar los algoritmos a los casos',
        }
